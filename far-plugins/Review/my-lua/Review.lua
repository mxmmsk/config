...
-- PicView compatible: * - 100%
Macro 
{ 
  description="Review: Scale 100%"; area="Dialog"; key="Multiply"; condition=Review.IsView;
...
-- PicView compatible: Add/Subtract - zooming
Macro 
{ 
  description="Review: Scale QuickView Add/Subtract"; area="Dialog"; key="Add Subtract"; condition=Review.IsView;

  action=function()
    Review.Scale(3, akey(1) == "Add" and 5 or -5)
  end;
}
...
Macro
{
  description="Review: Goto Page ..."; area="Dialog Shell"; key="CtrlG"; condition=Review.IsActive;
  action=function()
    local s = ""
    local GetPages = true
    repeat
